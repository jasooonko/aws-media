...
%build
%configure \
  --with-package-name='Amazon GStreamer-plugins-base package' \
  --enable-experimental \
  --enable-gtk-doc \
  --enable-orc \
  --disable-cdparanoia \
...
- First test with gstreamer-plugins-base 1.5.2
- Based on Fedora: gstreamer1-plugins-base-1.5.2-1.fc23.src.rpm
